i18next.init({
    ...
    resources: {
        ...
        duck: {
            translation: {
                "title": "Coin coin coin coin",
                "website-title": "CoinCoin",
                "menu-title": "Coin",
                "language-button": "Coin coin",
                "language-menu-button-mobile": "Coin coin :",
                "french-button": "🇫🇷 Coin",
                "english-button": "🇬🇧 Coin",
                "coin-button": "🦆 Coin",
                "french-mobile-button": "🇫🇷 Coin",
                "english-mobile-button": "🇬🇧 Coin",
                "coin-mobile-button": "🦆 Coin",
                "main-menu-about-link": "Coin coin",
                "main-title": "Coin coin coin coin coin !",
                "main-sub-title": "Coin coin coin coin coin coin coin coin coin coin coin !",
                "main-button": "Coin !",
                "navAction": "Coin !",
                "voice-section-main-title": "Coin coin coin COIN coin !",
                "voice-section-title": "Coin coin coin coin!",
                "voice-section-main-text": "Coin coin coin coin coin coin coin coin coin coin coin coin coin coin  coin coin !",
                "voice-section-button": "Coin coin coin !",
                "screen-section-main-title": "Coin coin coin coin coin coin coin coin coin!",
                "parc-section-title": "Coin coin coin coin coin coin coin coin coin !",
                "parc-section-main-text": "Coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin.",
                "bar-section-title": "Coin coin !",
                "bar-section-main-text": "Coin coin coin coin coin coin coin coin coin coin coin coin coin !",
                "footer-title": "Coin !",
                "footer-subtitle": "Coin coin coin coin coin coin!",
                "website-title-footer": "CoinCoin",
                "link-footer": "Coin",
                "faq-link-footer": "Coin",
                "help-link-footer": "Coin",
                "support-link-footer": "Coin",
                "legal-footer": "Coin",
                "legal-link-footer": "Coin",
                "privacy-link-footer": "Coin",
                "social-footer": "Coin",
                "github-link-footer": "Coin",
                "discord-link-footer": "Coin",
            }
        }
    }
});
